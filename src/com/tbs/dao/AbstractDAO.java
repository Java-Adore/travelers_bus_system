...
public abstract class AbstractDAO<T extends DTO> implements Serializable {
	...
	public <X extends DTO> X merge(X x) {
		EntityTransaction transaction = null;
		try {
			transaction = entityManager.getTransaction();
			if (transaction.isActive() == false) {
	...
	public void refresh(DTO marked) {
